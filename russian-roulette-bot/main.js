...
function populateLeaderboard () {
	var shotAllTime = JSON.parse(AJAX_JSON_Req( 'leaderboards/all-time/shot/current.json' ););
	var notShotAllTime = JSON.parse(AJAX_JSON_Req( 'leaderboards/all-time/not-shot/current.json' ););
	var shotThisWeek = JSON.parse(AJAX_JSON_Req( 'leaderboards/weekly/shot/current.json' ););
	var notShotThisWeek = JSON.parse(AJAX_JSON_Req( 'leaderboards/weekly/not-shot/current.json' ););
